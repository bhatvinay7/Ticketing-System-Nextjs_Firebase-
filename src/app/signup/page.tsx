...
function SignUp() {
  ...
  return(
       <>
        <Header/>
      <div className=" min-h-screen relative flex flex-col gap-8 items-center justify-center   bg-blue-300/45 p-2 ">
             
            <div className=' w-full p-6  lg:w-1/2 absolute top-4 bg-white  bg-contain sm:w-3/5 sm:left-60 lg:left-1/2 lg:bg-cover  bg-no-repeat h-[600px] rounded-3xl bg-signUpImage  '></div>
            ...
            {error ?
             ...
             :<></>}
            <div className=" z-[34]  relative border-2 border-violet-700/25 border-l-4 box-border border-l-white/75 bg-gradient-to-b from-slate-200 to-blue-200/25 p-6 rounded-lg shadow-lg w-full backdrop-blur-sm  max-w-sm">
